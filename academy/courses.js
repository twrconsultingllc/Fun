 ...
 *             put the 11-character ID here, e.g. youtube: 'dQw4w9WgXcQ'.
 */
window.ACADEMY = {
    courses: [
        {
            ...
            lessons: [
                {
                    ...
                    sections: [
                        ...
                        },
                        {
                            ...
                            text: ['Watch the head and hip line in the video below, then try the drill set in the next section.'],
                            video: { youtube: '', title: 'Freestyle body position demo' }
                        },
                        {
                            heading: 'Drill set',
                            bullets: [
            ...
            lessons: [
                {
                    ...
                    sections: [
                        ...
                        { heading: 'See a fit check', video: { youtube: '', title: 'Five-minute home bike fit' } }
                    ]
                },
                { title: 'Cadence & Gearing', summary: 'Spin at 85–95 rpm and save your legs.', minutes: 9, sections: [{ heading: 'Find your cadence', text: ['Count right-foot pedal strokes for 30 seconds and double it. Aim for 85–95 on the flats.'], video: { youtube: '', title: 'Cadence drills' } }] },
                { title: 'Pacing the Bike Leg', summary: 'Ride by effort, not by ego.', minutes: 12, sections: [{ heading: 'Effort zones', bullets: ['Sprint: hard but controlled', 'Olympic: comfortably hard', '70.3 / Ironman: all-day steady'] }] }
            ]
        },
        {
            id: 'run',
            ...
            lessons: [
                {
                    ...
                    minutes: 10,
                    sections: [
                        { heading: 'Tall and relaxed', text: ['Run tall with a slight forward lean from the ankles. Keep shoulders loose and arms swinging forward and back, not across your body.'], image: { art: 'run', caption: 'Land with your foot under your hips, not out in front.' } },
                        { heading: 'Form drills', video: { youtube: '', title: 'Running drills: A-skips and high knees' } }
                    ]
                },
                ...
                { title: 'Race-Day Run Pacing', summary: 'Start slower than you think.', minutes: 9, sections: [{ heading: 'The first mile', text: ['Aim to run the first mile 10–15 seconds per mile slower than goal pace, then settle in.'] }] }
            ]
        },
        {
            id: 'transitions',
